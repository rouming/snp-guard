...
pub async fn verify_report_core(
    ...
    // Verify nonce (must be generated by our code, signed with ephemeral secret, not expired)
    ...
    // Verify binding hash (report_data must match SHA512(server_nonce || client_pub_bytes))
